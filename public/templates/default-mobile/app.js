...
new _carousel__WEBPACK_IMPORTED_MODULE_1__.AdvantageCarousel();
new _loader__WEBPACK_IMPORTED_MODULE_3__.Loader('pageLoader');
...
/* harmony export */   AdvantageCarousel: () => (/* binding */ AdvantageCarousel),
...
/* harmony export */ });
var GoToElem = function GoToElem() {
  window.addEventListener("click", function (_ref) {
    var target = _ref.target;
    var scrollTarget = target.dataset.scrollTo;
    if (!scrollTarget) return;
    var elem = document.getElementById(scrollTarget);
    elem === null || elem === void 0 || elem.scrollIntoView({
      behavior: "smooth"
    });
  });
};
...
/* harmony export */ });
var Loader = function Loader(elem) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkoriginal"] = self["webpackChunkoriginal"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["app"], () => (__webpack_require__("./js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["app"], () => (__webpack_require__("./app.css")))
