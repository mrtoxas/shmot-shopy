...
Route::middleware(['auth', 'verified'])->group(function () {
  ...
  Route::post('/api/landings', 
    [LandingController::class, 'store'])->name('api.landings.store');  

  Route::get('/api/landings', 
    [LandingController::class, 'index'])->name('api.landings.all');

  Route::get('/api/landings/{landingId}', 
    [LandingController::class, 'fetchWithAllData'])->name('api.landingData.index');
});
...
Route::middleware(['auth', 'verified', 'check_landing_access'])->group(function () {
    ...
    Route::delete('/api/landings/{landingId}', 
        [LandingController::class, 'destroy'])->name('api.landing.destroy');
    
    Route::post('/api/landing/{landingId}/settings', 
        [SettingsController::class, 'update'])->name('api.settings.update');
    
    Route::post('/api/landing/{landingId}/global_product', 
        [GlobalProductController::class, 'update'])->name('api.globalProduct.update');
    
    Route::post('/api/landing/{landingId}/advantages', 
        [AdvantageController::class, 'update'])->name('api.advantages.update');

    Route::get('/api/landings/{landingId}/product/{productId}', 
        [ProductController::class, 'fetchWithAllData'])->name('api.product.index');

    Route::post('/api/landing/{landingId}/product', 
        [ProductController::class, 'store'])->name('api.products.store');

    Route::delete('/api/landings/{landingId}/product/{productId}', 
        [ProductController::class, 'destroy'])->name('api.product.destroy');
...
Route::get('/api/templates', 
    [LandingTemplateController::class, 'getAllThemes'])->name('api.templates.all');

Route::get('/api/templates/{id}', 
    [LandingTemplateController::class, 'getThemeById'])->name('api.templates.single');
