<form action="{{ route('order') }}" method="POST" class="w-2/3 space-y-6 mx-auto">
  @csrf
  ...
  <div class="text-center">
    <button type="submit" class="h-16 px-6 text-white bg-primary ring-4 focus:outline-none ring-primary/25 font-bold text-center me-2 my-2 rounded-full hover:bg-primary-darker">Залишити замовлення</button>
  </div>
</form>